<?php get_header(); ?>
<?php get_template_part('includes/top-blog') ?>
<!-- INIZIO BLOG -->
    <section id="blog">
        <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-sm-12 col-md-8 col-lg-8">
                <h2 class="t-black mt-1">Risultati della ricerca</h2>
              ...
              <?php endwhile; else: ?>
                <h3 class='ml-5 t-black'><?php echo 'Spiacente, non ci sono risultati per la tua ricerca su: <b> '.get_search_query(). ' </b> <br/> prova con una nuova parola.' ;?></h3>
              <?php endif; ?>
                <!-- ! Paginazione -->
                <nav>
